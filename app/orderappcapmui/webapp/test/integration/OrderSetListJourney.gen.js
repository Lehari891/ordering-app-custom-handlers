...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("OrderSetListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheOrderSetListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheOrderSetListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheOrderSetListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheOrderSetListGenerated.onTable(defaultTableId).iCheckRows();
        //     When.onTheOrderSetListGenerated.onFilterBar().iChangeSearchField(undefined);
        //     Then.onTheOrderSetListGenerated.onFilterBar().iCheckSearchField(undefined);
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheOrderSetListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheOrderSetListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheOrderSetListGenerated.onTable(defaultTableId).iPressRow(0);
            Then.onTheOrderSetObjectPageGenerated.iSeeThisPage();
        });
